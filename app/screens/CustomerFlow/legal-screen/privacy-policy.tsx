...
const CustomerPrivacyPolicyScreen = () => {
  return (
    <Screen>
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={[styles.section, { marginVertical: 15}]}>
          ...
          type='small_regular' color='primary40'
            text="At Sweeftly, we value your privacy and are committed to protecting your personal data. This policy explains how we collect, use, and safeguard your information when you use our app."
          />
        </View>
        ...
        <View style={styles.section}>
          <Text text="Information we collect" type='body_medium' color='primary80'/>
          <View style={styles.bulletList}>
            <View style={styles.bulletItem}>
              <Text style={styles.bulletPoint} text="•" />
              <Text type='small_regular' color='primary40' text="Personal Information: Name, email, phone number, address, and payment details" />
            </View>
            <View style={styles.bulletItem}>
              <Text style={styles.bulletPoint} text="•" />
              <Text type='small_regular' color='primary40' text="Order Details: Items purchased, vendors, and transaction history" />
            </View>
            <View style={styles.bulletItem}>
              <Text style={styles.bulletPoint} text="•" />
              <Text
              type='small_regular' color='primary40'
                text="Location Data: To show nearby vendors and deliver orders"
              />
            </View>
          </View>
        </View>
        ...
        <View style={styles.section}>
          <Text text="How we use your information" type='body_medium' color='primary80'/>
          <View style={styles.bulletList}>
            <View style={styles.bulletItem}>
              <Text style={styles.bulletPoint} text="•" />
...
export default CustomerPrivacyPolicyScreen;
