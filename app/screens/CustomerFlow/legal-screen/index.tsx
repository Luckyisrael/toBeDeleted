    ...
    <Screen bgColor="#fff">
      <View style={styles.container}>
        ...
        <Pressable
          ...
          onPress={() => navigation.navigate('CUSTOMER_TERMS_CONDITIONS_SCREEN')}>
            <View style={{ width: '80%'}}>
        ...
        <Pressable
          style={styles.menuItem}
          onPress={() => navigation.navigate('CUSTOMER_PRIVACY_POLICY_SCREEN')}>
          <View style={{ width: '80%'}}>
        ...
        <Pressable
          style={styles.menuItem}
          onPress={() => navigation.navigate('CUSTOMER_CONTACT_US_SCREEN')}>
          <View style={{ width: '80%'}}>
...
export default CustomerLegalScreen;
